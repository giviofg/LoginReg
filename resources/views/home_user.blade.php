                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-8">
                                <div class="hero__caption">
                                    ...
                                    <!-- Hero-btn -->
                                    <div class="hero__btn">
                                        <a href="#" class="btn hero-btn"  data-animation="fadeInLeft" data-delay=".8s"><s>Learn More</s></a>
                                        <a href="#" class="btn border-btn ml-15" data-animation="fadeInRight" data-delay="1.0s"><s>Hire Me</s></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row ">
                    <div class="col-lg-5">
                        <div class="about-caption mb-50">
                            <h3>Hai, {{ Session::get('name') }}. Apa kabar?</h3>
                    ...
                    <div class="col-lg-5 offset-lg-1">
                        <div class="about-caption2">
                            <h3>Status Login:<br>
                            <a href="#" class="btn btn-success btn-block">{{ Session::get('login') }}</a></h3>
                            <p>Email Kamu:</p>
                           <div class="send-cv">
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-xl-6 col-lg-8 col-md-8">
                        <div class="wantToWork-caption wantToWork-caption2">
                            <h2>Don’t worry for contact I’m not available</h2>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 col-md-3">
                        <a href="#" class="btn btn-black f-right"><s>Contact Me Now</s></a>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-xl-5 col-lg-5">
                        <form action="#" class="contact-wrapper">
                            ...
                            <button class="submit-btn2" type="submit"><s>Send Message</s></button>
                        </form>
                    </div>
                </div>
            </div>
